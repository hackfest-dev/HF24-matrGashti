    ...
    <div>
      ...
      <hr />
            <div className="flex justify-center flex-col mx-20  p-5 items-center mt-14">
                ...
                <button class="relative mt-5 text-2xl overflow-hidden bg-red-500 hover:bg-red-600 focus:bg-red-600 active:bg-red-700 rounded-md text-white py-5 px-10 transition duration-300 ease-in-out">
